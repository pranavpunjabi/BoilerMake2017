  ...
  */
   ...
   */
		...
		value: function claimDevice(_ref9) {
			...
			var requestTransfer = _ref9.requestTransfer;
			var auth = _ref9.auth;
   ...
   */
		...
		value: function getClaimCode(_ref12) {
			...
			var _ref12$iccid = _ref12.iccid;
			var iccid = _ref12$iccid === undefined ? undefined : _ref12$iccid;
		...
		value: function validatePromoCode(_ref13) {
			...
			var promoCode = _ref13.promoCode;
		...
		value: function changeProduct(_ref14) {
			...
			var shouldUpdate = _ref14.shouldUpdate;
   ...
   */
		...
		value: function compileCode(_ref19) {
			...
			var platformId = _ref19.platformId;
			var targetVersion = _ref19.targetVersion;
   ...
   */
		...
		value: function sendPublicKey(_ref21) {
			...
			var key = _ref21.key;
			var algorithm = _ref21.algorithm;
   ...
   */
		...
		value: function publishEvent(_ref24) {
			...
			var isPrivate = _ref24.isPrivate;
   ...
   */
		...
		value: function createWebhook(_ref25) {
			...
			var url = _ref25.url;
			var requestType = _ref25.requestType;
			var headers = _ref25.headers;
			var json = _ref25.json;
			var query = _ref25.query;
			var responseTemplate = _ref25.responseTemplate;
			var responseTopic = _ref25.responseTopic;
			var rejectUnauthorized = _ref25.rejectUnauthorized;
			var webhookAuth = _ref25.webhookAuth;
   ...
   */
		...
		value: function setUserInfo(_ref29) {
			...
			var accountInfo = _ref29.accountInfo;
			var password = _ref29.password;
		...
		value: function activateSIM(_ref31) {
			...
			var countryCode = _ref31.countryCode;
   ...
   */
		...
		value: function listBuildTargets(_ref32) {
			...
			var _ref32$onlyFeatured = _ref32.onlyFeatured;
			var onlyFeatured = _ref32$onlyFeatured === undefined ? undefined : _ref32$onlyFeatured;
   ...
   */
		...
		value: function listLibraries(_ref33) {
			...
			var filter = _ref33.filter;
			var sort = _ref33.sort;
			var architectures = _ref33.architectures;
			var category = _ref33.category;
			var scope = _ref33.scope;
			var excludeScopes = _ref33.excludeScopes;
